...
- **Trust boundaries:** where does data cross from less-trusted to more-trusted (client to server, tenant to tenant, user to admin, external API to internal)? Every boundary is a place to check authz and validation.
