...
Reference for Step 3 (writing mode). Structure, norms, and gotchas for the five most common marketing page types.
...
**Purpose:** Establish what the product is and who it's for. Serve the primary visitor segment without becoming so generic it serves no one.

**Primary challenge:** Multiple audience segments visit the homepage, but trying to write for everyone produces copy that resonates with no one. Pick the highest-value segment and write for them directly.
...
**Gotcha:** Don't add a secondary CTA ("or watch a video") that dilutes the primary action. If you must, make the primary CTA visually dominant by 3:1.

---

## Landing page

**Purpose:** Drive a single action from a specific traffic source. Message must match what brought the reader here (ad, email, link).

**Primary challenge:** Message match. If the ad said "Cut your AWS bill in half" and the landing page opens with "Welcome to CloudSave", you've already lost them. The headline must mirror the promise that brought them.

**Recommended framework:**
- **PAS** for problem-aware traffic (they know they have the problem, need to be convinced your solution is right)
- **AIDA** for cold traffic (they saw an ad, have no context)
...
**Primary challenge:** Decision paralysis. Too many options, unclear differentiation, or plans named by tier level ("Basic/Pro/Enterprise") instead of by buyer type.
