---
name: planning
description: Creates and reviews executable implementation plans grounded in repository evidence, with vertical slices, explicit decisions, and verification criteria. Use when asked to "plan this feature", "stress-test this plan", "grill me", or "split this into tickets". For architecture use codebase-architecture; for code review use tidy; to dispatch the tickets to agents use backlog.
---
...
For architecture contracts use `codebase-architecture`; for code findings use `tidy`; to dispatch published tickets to agents use `backlog`.
