...
Each finding is a JSON object (schema is compatible with `design` Audit mode findings, so the two reports merge):
...
Cross-reference:     Run design Audit mode for traditional UX findings
═══════════════════════════════════════════════════════════
```
