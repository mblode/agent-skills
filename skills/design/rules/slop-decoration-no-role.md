...
- **One faint grain layer that hides banding** (`references/visual/foundations.md` (Materials)) is a surface treatment, not atmosphere. Count it as the one allowed layer; extra noise stacks still fail.
