...
`references/visual/aesthetic-direction.md` treats invented proof as absolute rather than count-based, for exactly this reason: it misinforms rather than merely underwhelming.
