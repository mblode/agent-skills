...
This file owns the 44px number, and it is a conformance floor, not a build target. New UI in this skill ships 48x48 per `references/visual/components.md` (Buttons), which owns that number. An existing control between 44 and 47px is a pass with a note, never a fail.
