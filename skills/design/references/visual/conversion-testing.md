...
| 6 | **Page length** | Short vs long; see `conversion.md` for the decision matrix |
...
- **Most mobile users don't scroll to mid-page** (see the "70% rule" in `conversion-mobile.md`). Strongest proof or CTA below the mobile fold is never seen by most visitors.
