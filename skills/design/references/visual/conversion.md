...
Urgency (a subset of scarcity) lifts conversion substantially when real, and destroys credibility when fabricated. For the figure and other CTA conversion stats, see the canonical "CTA statistics" table in `conversion-testing.md`.
...
Copy research (mining reviews, tickets, and transcripts for the reader's exact words) is done here; the reader's words then go into `ghostwriter`'s copy brief.
