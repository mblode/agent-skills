...
- Study the annotated "Reference calibration" list in [build.md](build.md) (Linear, Raycast, Things 3, OpenAI, ElevenLabs, Mintlify, Family, Zed) for what each is calibration for.
