...
| File | What it covers |
|------|---------------|
| [references/cro.md](references/cro.md) | Persuasion psychology (Cialdini), social proof patterns, conversion benchmarks, Voice of Customer research, page length decision |
