...
- Copywriting quality on the empty-state body text: defer to a copy review (the external `ghostwriter` skill where installed) (this rule only requires a CTA, not perfect copy).
