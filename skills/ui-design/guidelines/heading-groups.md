...
The measures below are heading measures, deliberately tighter than body text. Running body copy is a different rule with a different range, owned by `rules/type-measure-leading.md`; a 24ch headline is correct here and is not a violation of it.
