...
- Long content must never push the confirm and cancel actions out of reach. The decision that the actions stay reachable is this skill's; whether the modal body actually scrolls correctly is a rendered check for `ui-audit` and the project's lint.
